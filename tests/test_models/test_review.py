...
class TestReview_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        rvw = Review()
        rvw.id = "123456789"
        rvw.created_at = rvw.updated_at = dtime
        rvwstr = rvw.__str__()
        self.assertIn("[Review] (123456789)", rvwstr)
        self.assertIn("'id': '123456789'", rvwstr)
        self.assertIn("'created_at': " + dtime_repr, rvwstr)
        self.assertIn("'updated_at': " + dtime_repr, rvwstr)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        rvw = Review(id="345", created_at=dtime_iso, updated_at=dtime_iso)
        self.assertEqual(rvw.id, "345")
        self.assertEqual(rvw.created_at, dtime)
        self.assertEqual(rvw.updated_at, dtime)
...
class TestReview_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        rvw = Review()
        rvw.middle_name = "School"
        rvw.my_number = 98
        self.assertEqual("School", rvw.middle_name)
